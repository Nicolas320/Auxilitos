...
<x-app-layout>
    ...
    <div class="container text-center" id="container-padre">
        ...
        <form>
            <label for="numero-contenedores">Número de contenedores:</label>
            ...
            <button class="btn btn-success" type="submit">Generar contenedores</button>
        </form>
        ...
        <form action="{{ route('storePreguntas5_7') }}" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    <script src="{{ asset('js/aparecer-container.js') }}"></script>
</x-app-layout>
